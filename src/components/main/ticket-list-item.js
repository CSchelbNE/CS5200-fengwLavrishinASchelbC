...
const TicketListItem = ({props}) => {
    ...
    return (
        <Flex p="2" backgroundColor={props.background} onClick={(e) => {props.callback({...props, callback: null})}} alignItems="center" height="fit-content" width="100%" border="1px solid lightgrey" direction="row">
