...
import {acceptTicket, closeTicket, createComment, getAssignedTickets, getOpenTickets} from "./technician-services";
...
export const createCommentThunk = createAsyncThunk("technician/create-comment",
    async (comment) => {
